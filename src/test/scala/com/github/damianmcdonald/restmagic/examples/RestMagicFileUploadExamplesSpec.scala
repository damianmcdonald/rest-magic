...
class RestMagicFileUploadExamplesSpec extends Specification with Specs2RouteTest with RestMagicApi {
  ...
  "The FileUploadService created via RestMagicFileUploadExamples" should {
  ...
  "The FileUploadErrorService created via RestMagicFileUploadExamples" should {
